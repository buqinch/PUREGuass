...
# --------------------------------------------------------
# CroCo model during pretraining with DIFF Transformer
# --------------------------------------------------------
...
# 只从blocks_DIFF导入需要的组件
from .blocks_DIFF import DIFFBlock, DIFFDecoderBlock, PatchEmbed
...
class CroCoNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 lambda_init=0.1,        # 添加DIFF特有的参数：lambda初始化值
                ):
        ...
        # transformer for the encoder - 使用DIFFBlock替代Block
        self.enc_depth = enc_depth
        self.enc_embed_dim = enc_embed_dim
        self.enc_blocks = nn.ModuleList([
            DIFFBlock(
                enc_embed_dim, enc_num_heads, mlp_ratio, qkv_bias=True, 
                norm_layer=norm_layer, rope=self.rope,
                lambda_init=lambda_init, layer_idx=i, max_layer=enc_depth
            )
        ...
        # decoder 
        self._set_decoder(enc_embed_dim, dec_embed_dim, dec_num_heads, dec_depth, mlp_ratio, norm_layer, norm_im2_in_dec, lambda_init)
    ...
    # 更新_set_decoder方法，添加lambda_init参数
    def _set_decoder(self, enc_embed_dim, dec_embed_dim, dec_num_heads, dec_depth, mlp_ratio, norm_layer, norm_im2_in_dec, lambda_init):
        ...
        # transformer for the decoder - 使用DIFFDecoderBlock替代DecoderBlock
        self.dec_blocks = nn.ModuleList([
            DIFFDecoderBlock(
                ...
                lambda_init=lambda_init, layer_idx=i, max_layer=dec_depth
            )
